import { Position, Range, Selection, TextEditorCursorStyle, TextEditor, TextEditorDecorationType, ThemeColor, window } from "vscode";
...
export class HighlightGrid extends Disposable {
    ...
    constructor({ runtime, editor, id }: GridConstructorArg) {
        super();
    ...
    update(calls: [number, number, number, any[]][]) {
